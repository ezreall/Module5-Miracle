...
export class RegisterServiceService {
  ...
  getMyService():Observable<any>{
    return this.http.get<any>(environment.url_api + 'services/myservice',this.authService.getHeader());
  }
  ...
  updateService(data:any,id:any):Observable<any> {
    return this.http.post<any>(environment.url_api +   'services/'+id+'/update',data,this.authService.getHeader());
  }
